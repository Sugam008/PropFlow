...
test.describe('Accessibility Audit', () => {
  ...
  test('should not have any automatically detectable accessibility issues on Property Detail page', async ({ page }) => {
    const propId = 'prop_1';
  ...
  test('should not have any automatically detectable accessibility issues on Analytics page', async ({ page }) => {
    // Mock API responses
    await page.route('**/properties/**', async (route) => {
      await route.fulfill({
        status: 200,
