...
describe('Home Page', () => {
  ...
  it('renders loading state', () => {
    ...
    render(<Home />);
    expect(screen.getByLabelText(/Loading properties/i)).toBeDefined();
  });
  ...
  it('renders property list correctly', () => {
    const properties = [
      { id: 'prop_1', address: '123 Main St', city: 'Mumbai', state: 'MH', status: 'SUBMITTED', property_type: 'APARTMENT' },
      { id: 'prop_2', address: '456 Park Ave', city: 'Delhi', state: 'DL', status: 'DRAFT', property_type: 'HOUSE' },
    ];
  ...
  it('filters properties based on search term', () => {
    const properties = [
      { id: 'prop_1', address: '123 Main St', city: 'Mumbai', status: 'SUBMITTED', property_type: 'APARTMENT' },
      { id: 'prop_2', address: '456 Park Ave', city: 'Delhi', status: 'DRAFT', property_type: 'HOUSE' },
    ];
    (useQuery as any).mockReturnValue({ isLoading: false, data: properties });
